...
class Login extends React.Component {
    ...
    render() {
        ...
        return (
            <div id="form-login">
                <div className="login-header"><Icon type="api" /> Wholesale</div>
                <Form onSubmit={this.handleSubmit} className="login-form">
                    <FormItem>
                        {getFieldDecorator('email', {
                            rules: [{ required: true, message: 'Please input your email!' }],
                        })(
                            <Input prefix={<Icon type="user" style={{ color: '#eb7729' }} />} placeholder="Email" />
                        )}
                    </FormItem>
                    ...
                    <FormItem>
                        {getFieldDecorator('password', {
                            ...
                            <Input prefix={<Icon type="lock" style={{ color: '#eb7729' }} />} type="password" placeholder="Password" />
                        )}
                    </FormItem>
